...
<p>
OSiRIS is funded by the NSF via a CC*DNI DIBBs grant awarded to the University of Michigan, Michigan State, Wayne State and Indiana University. <a href="https://nsf.gov/awardsearch/showAward?AWD_ID=1541335&HistoricalAwards=false">Award Details</a> are publicly available on the NSF website.  The project also incorporates a small storage cache tier and services for researchers at the Van Andel Institute.  
</p>
<a href="{{IMAGE_PATH}}/OSiRIS-Overview.jpg"><img src="{{IMAGE_PATH}}/OSiRIS-Overview.jpg" style="width: 70%"></a>


<a href="{{IMAGE_PATH}}/MI-OSiRIS-Logical-view.png"><img src="{{IMAGE_PATH}}/MI-OSiRIS-Logical-view.png" alt="OSiRIS Overview" style="width: 60%" class="rf"></a>
<p>
