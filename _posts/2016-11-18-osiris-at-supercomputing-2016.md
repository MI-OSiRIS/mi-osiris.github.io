...
---
{% include JB/setup %}
<div class="rf imgwrap" style="width:35%">
<a href="{{IMAGE_PATH}}/sc16/BoothCrates-UM.jpg"><img style="width: 100%"  src="{{IMAGE_PATH}}/sc16/BoothCrates-UM.jpg" alt="OSiRIS Equipment at SC"></a>
...
<div class="imgwrap" style="margin-bottom: 20px; margin-top: 20px;" >
<a href="{{IMAGE_PATH}}/sc16/SC16SiteMap.png"><img src="{{IMAGE_PATH}}/sc16/SC16SiteMap.png" alt="OSiRIS Sites during SC16" style="width: 100%"></a>
</div>


<div class="lf imgwrap" style="width: 35%">
<a href="{{IMAGE_PATH}}/sc16/BoothCrates-MSU.jpg"><img style="width: 100%" src="{{IMAGE_PATH}}/sc16/BoothCrates-MSU.jpg"></a>
