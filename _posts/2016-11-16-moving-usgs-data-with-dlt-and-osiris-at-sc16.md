...
<div id="dltviz_excerpt" class="rf imgwrap" style="width:40%">
<a href="{{IMAGE_PATH}}/sc16/dlt_dlviz.gif"><img src="{{IMAGE_PATH}}/sc16/dlt_dlviz.gif" alt="DLT Data Movement Visualization" class="lf" style="width: 100%"></a>
</div>
...
<div class="imgwrap" style="width:100%; margin-bottom: 20px">
<a href="{{IMAGE_PATH}}/sc16/dlt_dlviz.gif"><img src="{{IMAGE_PATH}}/sc16/dlt_dlviz.gif" alt="DLT Data Movement Visualization" style="width: 100%"></a>
...
<div class="imgwrap" style="width:100%; margin-bottom: 20px">
<a href="{{IMAGE_PATH}}/sc16/sc16_osiris_wm.png"><img src="{{IMAGE_PATH}}/sc16/sc16_osiris_wm.png" alt="SC16 network weather map" style="width: 100%"></a>
