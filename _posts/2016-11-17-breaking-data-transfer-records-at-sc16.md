...
<div class="imgwrap lf" style="width: 35%">
	<a href="{{IMAGE_PATH}}/sc16/total-showfloor-Thursday.jpg">
		<img src="{{IMAGE_PATH}}/sc16/total-showfloor-Thursday.jpg" alt="Total SCinet traffic monitored by sflow/netflow" style="width: 100%">
	</a>
...
<a href="{{IMAGE_PATH}}/sc16/SC-WanChallenge-OSiRIS-Switch-Incoming.png"><img src="{{IMAGE_PATH}}/sc16/SC-WanChallenge-OSiRIS-Switch-Incoming.png" style="width:100%" alt="Incoming traffic to OSiRIS switch"></a>
...
<div class="imgwrap" style="width:100%; margin-bottom: 50px">
<a href="{{IMAGE_PATH}}/sc16/SC-BandwidthChallenge-OSiRIS-Sites-Stacked.png"><img src="{{IMAGE_PATH}}/sc16/SC-BandwidthChallenge-OSiRIS-Sites-Stacked.png" style="width:100%" alt="Traffic Outgoing from OSiRIS sites"></a>
...
<div class="imgwrap" style="width:100%; margin-bottom: 50px; margin-top: 50px">
<a href="{{IMAGE_PATH}}/sc16/SC16 Physical Topology.png"><img src="{{IMAGE_PATH}}/sc16/SC16 Physical Topology.png" style="width: 100%" alt="SC16 Physical Topology"></a>
...
<a href="http://www.centurylink.com"><img style="width: 45%; padding-right: 50px" src="{{IMAGE_PATH}}/sc16/CenturyLink_2010_logo.svg.png" alt="CenturyLink Logo"></a>
<a href="http://www.zayo.com"><img style="width:30%" src="{{IMAGE_PATH}}/sc16/large_Zayo.png" alt="Zayo Logo"></a>

Thanks to Juniper and Adva for providing network equipment.

<a href="http://www.juniper.net"><img style="width: 40%; padding-right: 50px" src="{{IMAGE_PATH}}/sc16/juniper-networks-blue-png.png" alt="Juniper Logo"></a>
