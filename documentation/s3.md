...
Once you have been enrolled into OSiRIS you can retrieve an access token for S3 access at the endpoints noted above. 
...
As far as setting up ACL:  At this time we can only refer you to external instructions.  We have not yet created step-by-step instructions for our users.  If the instructions below are not helpful please let us know and we'll be happy to assist.  

<a href="http://boto3.readthedocs.io/en/latest/guide/s3-example-access-permissions.html">Bucket ACL in Python Boto</a>

<a href="https://trac.cyberduck.io/wiki/help/en/howto/s3#AccessControlACL">Bucket ACL in CyberDuck</a>
...
A common S3 client is python Boto.  The examples at ceph.com refer to boto2 but you may be using the most current boto3.  Please note that you will have to specify one of the OSiRIS S3 URLS noted above when creating your S3 connections.
...
A common GUI S3 client is <a href="https://cyberduck.io">Cyberduck</a>.  Again, be sure you are configuring your connection to use an OSiRIS S3 URL as listed above.
