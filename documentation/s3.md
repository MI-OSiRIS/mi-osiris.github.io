...
A common S3 client library is python Boto.  The examples at ceph.com refer to boto2 but you may be using the most current boto3.  
...
A common CLI S3 client is <a href="https://github.com/s3tools/s3cmd">s3cmd</a>.  This is a good option for inclusion in scripts.   

A common GUI S3 client is <a href="https://cyberduck.io">Cyberduck</a>.  

*** Please note that with any client you will have to specify one of the OSiRIS S3 URLS noted above when creating your S3 connections.
